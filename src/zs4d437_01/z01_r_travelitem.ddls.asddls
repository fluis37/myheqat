...
define view entity Z01_R_TRAVELITEM
  as select from z01_tritem
  association to parent Z01_R_TRAVEL as _Travel
    on $projection.AgencyId = _Travel.AgencyId
    and $projection.TravelId = _Travel.TravelId
    
    association to Z01_E_TravelItem    as _Extension
