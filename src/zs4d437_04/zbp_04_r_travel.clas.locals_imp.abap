...
CLASS lsc_z04_r_travel IMPLEMENTATION.
  ...
  METHOD save_modified.
    ...
    LOOP AT delete-item INTO DATA(item_d).
    ...
    LOOP AT create-item INTO DATA(item_c).
    ...
    LOOP AT update-item INTO DATA(item_u).
  ...
  METHOD map_message.
    ...
    DATA(severity) = SWITCH #( i_msg-msgty WHEN 'E' THEN if_abap_behv_message=>severity-error
