...
CLASS lhc_item IMPLEMENTATION.
  ...
  METHOD ZZvalidateClass.
    ...
    READ ENTITIES OF Z05_R_Travel IN LOCAL MODE
      ENTITY item
      FIELDS ( agencyid travelid ZZClassZ05 )
    ...
    LOOP AT items ASSIGNING FIELD-SYMBOL(<item>).
      ...
      IF <item>-ZZClassZ05 IS INITIAL.
        ...
        APPEND VALUE #( %tky = <item>-%tky
                        ...
                        %element-ZZClassZ05 = if_abap_behv=>mk-on
                        %state_area = c_area
...
CLASS lsc_Z05_R_TRAVEL DEFINITION INHERITING FROM cl_abap_behavior_saver.
  PROTECTED SECTION.
...
CLASS lsc_Z05_R_TRAVEL IMPLEMENTATION.

  METHOD save_modified.
    LOOP AT update-item ASSIGNING FIELD-SYMBOL(<item>)
    WHERE %control-ZZClassZ05 = if_abap_behv=>mk-on.

      UPDATE z05_tritem
      SET zzclassz05 = @<item>-ZZClassZ05
