...
CLASS lsc_z02_r_travel IMPLEMENTATION.
  ...
  METHOD save_modified.
    ...
    DATA(model) = NEW zcl_02_tritem( i_table_name = 'Z02_TRITEM' ).
    ...
    IF create-travel IS NOT INITIAL.
      DATA event_in TYPE TABLE FOR EVENT Z02_R_Travel~TravelCreated.
      ...
      ENDLOOP.
      RAISE ENTITY EVENT Z02_R_Travel~TravelCreated FROM event_in .
    ENDIF.
